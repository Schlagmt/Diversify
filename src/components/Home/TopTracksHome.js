...
export class TopTracksHome extends Component {
    ...
    render() {
        ...
        return (
            <Col>
                <img className="bg-image" src={this.state.topTracks.items[0].album.images[0].url} alt={this.state.topTracks.items[0].album.name} style={{maxHeight:"100%",maxWidth:"100%"}}></img>
